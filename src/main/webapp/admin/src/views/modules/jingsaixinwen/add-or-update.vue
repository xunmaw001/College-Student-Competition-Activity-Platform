    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="新闻简述" prop="xinwenjianshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="新闻简述"
                  v-model="ruleForm.xinwenjianshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xinwenjianshu" label="新闻简述" prop="xinwenjianshu">
                    <span>{{ruleForm.xinwenjianshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="竞赛内容" prop="jingsaineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jingsaineirong" label="竞赛内容" prop="jingsaineirong">
                    <span v-html="ruleForm.jingsaineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='xinwenjianshu'){
            this.ruleForm.xinwenjianshu = obj[o];
	    this.ro.xinwenjianshu = true;
            continue;
          }
          if(o=='jingsaineirong'){
	...
	this.ruleForm.jingsaineirong = this.ruleForm.jingsaineirong.replace(reg,'../../../ssms64ag/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingsaixinwen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingsaixinwenCrossAddOrUpdateFlag = false;
						 this.parent.search();
