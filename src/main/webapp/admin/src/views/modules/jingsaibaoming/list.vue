  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
	    ...
	    <download-excel v-if="isAuth('jingsaibaoming','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "竞赛报名.xls">
		      <!-- 导出excel -->
            	<el-button
...
//导出excel
      json_fields: {
      "报名编号": "baomingbianhao",    //常规字段
      "比赛名称": "bisaimingcheng",    //常规字段
      "人数": "renshu",    //常规字段
      "开始日期": "kaishiriqi",    //常规字段
      "学号": "xuehao",    //常规字段
      "姓名": "xingming",    //常规字段
      "手机": "shouji",    //常规字段
      "学院": "xueyuan",    //常规字段
      "专业": "zhuanye",    //常规字段
      "报名时间": "baomingshijian",    //常规字段
      "是否审核": "sfsh",    //常规字段
      "审核回复": "shhf",    //常规字段
      },
      json_meta: [
