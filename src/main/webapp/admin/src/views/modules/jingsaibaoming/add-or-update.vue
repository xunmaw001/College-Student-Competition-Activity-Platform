<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开始日期" prop="kaishiriqi">
          <el-input v-model="ruleForm.kaishiriqi" 
              placeholder="开始日期" clearable  :readonly="ro.kaishiriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开始日期" prop="kaishiriqi">
              <el-input v-model="ruleForm.kaishiriqi" 
