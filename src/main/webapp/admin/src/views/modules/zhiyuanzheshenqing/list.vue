        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="手机">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="gerenjianjie"
                   :header-align="contents.tableAlign"
                    label="个人简介">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download($base.url+scope.row.gerenjianjie)">下载</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
...
export default {
  ...
  methods: {
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          zhaomubianhao: row.zhaomubianhao,
