<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招募编号" prop="zhaomubianhao">
          <el-input v-model="ruleForm.zhaomubianhao" 
              placeholder="招募编号" clearable  :readonly="ro.zhaomubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招募编号" prop="zhaomubianhao">
              <el-input v-model="ruleForm.zhaomubianhao" 
                placeholder="招募编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.gerenjianjie" label="个人简介" prop="gerenjianjie">
          <file-upload
          tip="点击上传个人简介"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.gerenjianjie)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
